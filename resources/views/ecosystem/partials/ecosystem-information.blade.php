<div x-data="{
    ...
    <div class=" pb-5 flex justify-between">
        ...
        <div class="flex">
            <span class="hidden sm:block">
                <a href="{{url("ecosystem/$ecosystem->id/edit")}}"
    ...
    <x-confirm-delete-modal post-url="ecosystem/{{$ecosystem->id}}"
                            title="Are you sure"
                            subtitle="Please confirm if you would like to delete the ecosystem"
