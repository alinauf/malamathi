<div x-data="{
    ...
    <div class=" pb-5 flex justify-between">
        ...
        <div class="flex">
            <span class="hidden sm:block">
                <a href="{{url("atoll/$atoll->id/edit")}}"
    ...
    <x-confirm-delete-modal post-url="atoll/{{$atoll->id}}"
                            title="Are you sure"
                            subtitle="Please confirm if you would like to delete the atoll"
