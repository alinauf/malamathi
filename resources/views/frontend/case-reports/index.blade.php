            ...
            <div class="md:w-3/4 px-6 pb-6">
                @foreach($cases as $case)
                    ...
                    <a href="{{url("/case-reports/$case->id")}}">
                        ...
                        <article
                                class="mb-12 relative isolate flex flex-col gap-x-8 lg:flex-row hover:translate-x-1  transition-all cursor-pointer">
                            <div class="relative aspect-[16/9] sm:aspect-[2/1] lg:aspect-square lg:w-48 lg:shrink-0">
                                    ...
                                    if ($case->getMedia('case-report-images') != null && count($case->getMedia('case-report-images'))) {
                                        foreach ($case->getMedia('case-report-images') as $media) {
                                ...
                                <img src="{{$imageURL}}"
                                     alt=""
                                     class="absolute inset-0 h-full w-full rounded-full bg-gray-50 object-cover"/>
