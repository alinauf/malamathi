  <div class="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
    ...
    <div class="flex flex-col md:flex-row py-5 text-left max-w">

      <div class="md:w-2/3 ">
          <div class="introimage-container rounded max-h-[60vh] md:max-h-[40vh]">
          <div class="introimage">
              <img src="/aishath-naj-jwnsA9jX81U-unsplash.jpg" alt="Photography by - Aishath Naj (najphotos.com)">
          </div>
          </div>
      </div>
      ...
      <div class="md:w-1/3 px-6">
          ...
          <p class="lead flex my-6">
              <a class="flex btn px-5 py-3 text-lg text-white rounded bg-blue-600 hover:bg-blue-700 active:bg-blue-600"
                href="{{url("case-reports/create")}}" role="button">
    ...
    <div class="flex flex-col md:flex-row text-left max-w">
        <div class="md:w-2/3 px-6 pb-6 bg-blue-50 rounded-t md:rounded-l">
        ...
        <div class="md:w-1/3 px-6 pb-6 text-gray bg-green-50 rounded-b md:rounded-r">
...
<style>
  ...
  .introimage:before{
    ...
    background:url('/aishath-naj-jwnsA9jX81U-unsplash.jpg');
