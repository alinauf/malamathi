...
formValidationStatus:@entangle('formValidationStatus').live,
     ...
     x-transition:enter-start="opadocumented-0 transform scale-90"
     x-transition:enter-end="opadocumented-100 transform scale-100"
>


    <header>
        <h2 class="text-lg font-medium text-gray-900">
            {{ __('Add new Ecosystem') }}
        </h2>

        <p class="mt-1 text-sm text-gray-600">
            {{ __("Enter the details of the ecosystem") }}
        </p>
    </header>

    <form action="{{url("ecosystem")}}" method="POST">
        @csrf
        ...
        <x-confirm-create-modal title="Are you sure"
                                subtitle="Please confirm if you would like to create the ecosystem"/>
    </form>
</div>
