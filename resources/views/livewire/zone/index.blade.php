    ...
    <div class="px-4 sm:px-6 lg:px-8">
        <div class="sm:flex sm:items-center">
            <div class="sm:flex-auto">
                <h1 class="text-base font-semibold leading-6 text-gray-900">Zone</h1>
                <p class="mt-2 text-sm text-gray-700">List of all zones</p>
                            ...
                            @foreach($zones as $zone)
                                ...
                                <tr>
                                    ...
                                    <td class=" px-3 py-4 text-sm text-gray-500 text-ellipsis overflow-hidden">
                                        <a href="{{url("atoll/".$zone["atoll_id"])}}">
                                            {{$zone->atoll->name}}
                                        </a>
                                    </td>

                                    <td class=" px-3 py-4 text-sm text-gray-500 text-ellipsis overflow-hidden">
                                        <a href="{{url("island/".$zone["island_id"])}}">
                                            {{$zone->island->name}}
                                        </a>
                                    </td>

                                    <td class="relative whitespace-nowrap py-4 pl-3 pr-4 text-right text-sm font-medium sm:pr-6">
                                        <a href="{{url("zone/".$zone["id"])}}"
