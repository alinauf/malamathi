                ...
                <div class="p-4">
                    <div class="flex items-start">
                        ...
                        <div class="ml-3 w-0 flex-1 pt-0.5">
                            ...
                            <p class="mt-1 text-sm text-gray-500">
                                {{ is_string(session('failure')) ? session('failure') : 'Unknown Error!' }}
                                @php
                                if(
                                    !is_string(session('failure'))
                                ){
                                    \Log::error('Invalid Error posted to Session Failure:');
                                    \Log::error(session('failure'));
                                }
                                @endphp
                            </p>
                        </div>
