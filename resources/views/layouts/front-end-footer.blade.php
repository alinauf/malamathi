  <div class="mx-auto flex max-w-7xl px-2 sm:px-6 lg:px-8">
    ...
    <div class="md:w-1/3 px-6 pb-6">
            ...
            <br>
            <a class="hover:underline mb-1" href="#">Land Sea Maldives</a>
            </p>
    </div>
    ...
    <div class="md:w-1/3 px-6 pb-6">
            <h1 class="text-2xl my-4 font-serif font-bold text-gray-dark text-left pb-0"></h1>
            <p class="lead">
            </p>
    </div>

    <div class="md:w-1/3 px-6 pb-6">
            <div class="flex gap-3 float-left md:float-right">
                <img src="/img/landsea.png" alt="Land Sea" class="pr-1">
                <img src="/img/gef.png" alt="GEF" class="pr-1">
                <img src="/img/un.png" alt="UNDP" class="pr-1">
            </div>
    </div>
